...
from opy.common.o_db_exceptions import NotConnectedException
...
from opy.database.protocol.o_op_db import OOperationDBClose, OOperationDBOpen
from opy.database.protocol.o_op_init import OOperationInit
